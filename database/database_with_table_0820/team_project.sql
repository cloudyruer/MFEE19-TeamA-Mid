...
INSERT INTO `order_details` (`sid`, `order_number`, `product_id`, `price`, `quantity`) VALUES
(1, 1, 1, 3000, 1),
(2, 1, 7, 4000, 1),
(3, 2, 4, 3000, 1),
(4, 3, 5, 3000, 1),
...
INSERT INTO `order_list` (`sid`, `user_id`, `grand_total`, `order_status`, `user_name`, `user_phone`, `user_email`, `user_address`, `pickup_way`, `pickup_store`, `created_at`) VALUES
(1, 1, 6300, '等待結帳', 'emma', '0970469887', 'emma@emma.com', '403 臺中市西區大墩路28號', '貨到付款', '樂群門市', '2021-08-15 20:36:18'),
(2, 2, 3150, '已經結帳', 'tommy', '0936749544', 'tommy@tommy.com', '711 臺南市歸仁區大廟二街1號', '送貨到府', NULL, '2021-08-15 20:50:22'),
(3, 3, 3150, '等待結帳', 'joey', '0970034068', 'joey@joey.com', '369 苗栗縣卓蘭鎮民治街26號', '貨到付款', '新卓蘭門市', '2021-08-15 20:52:05'),
(4, 4, 8100, '已經結帳', 'li', '0919985971', 'li@li.com', '412 臺中市大里區立元路5號', '送貨到府', NULL, '2021-08-15 20:53:23'),
(6, 6, 5000, '已經結帳', 'pikachu', '0937196664', 'pikachu@pikachu.com', '249 新北市八里區仁愛路11號', '送貨到府', NULL, '2021-08-15 20:55:07'),
(9, 5, 0, '', 'Liu Ming-Xin', '0912123123', 'smallstars10@gmail.com', 'ulitsa Institutskaya, 4, Kiev', '貨到付款', NULL, '2021-08-19 11:30:19');
...
(2, 2, 10, 1, 'NIKE Jordan Delta 2', 'nike01black\r\n', 4500, 4500, 'Jordan Delta 2 在你喜愛的耐久性、舒適度和 Jordan 核心概念等特色上，增添全新大膽元素。我們延續 Delta 的一貫理念，改版設計線條，並去除部分元素。第二代鞋款同樣混搭了各式具支撐力與太空概念的衝突材質，結合不同紋理與大量縫線，打造既經典又新奇的造型。\r\n', '越南\r\n', 1, '2021-08-14 10:00:32'),
...
(1, '棒球', 1, '2021-08-15 20:35:57'),
(2, '中華職棒', 2, '2021-08-15 20:35:57');
...
CREATE TABLE `stadium` (
  `sid` int(11) NOT NULL,
  `name` varchar(255) NOT NULL COMMENT '場館名稱',
  `city` varchar(255) DEFAULT NULL COMMENT '城市',
  `area` varchar(255) DEFAULT NULL COMMENT '行政區',
  `address` varchar(255) DEFAULT NULL COMMENT '地址',
  `gymType` int(11) NOT NULL DEFAULT 1 COMMENT '運動類型',
...
INSERT INTO `stadium` (`sid`, `name`, `city`, `area`, `address`, `gymType`, `gymKind`, `inAndout`, `lat`, `lng`, `photo`, `phone`, `created_at`) VALUES
(1, '天母棒球場', '台北市', '士林區', '忠誠路二段77號', 1, 2, '室外', '25.11439823009718', '121.5326674079359', NULL, '+886228735688', '2021-08-15 20:45:29');
...
(1, '球類運動設施', 1, '2021-08-15 21:15:01'),
(2, '棒球場', 2, '2021-08-15 21:15:01');
