    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php foreach ($rows as $r) : ?>
                <tr>
                    <td><?= $r['name'] ?></td>
                    <td><a class="btn btn-info" href="033-leo-stadium-type-fun-edit.php?sid=<?= $r['sid'] ?>">編輯</a></td>
                    <td><a href="033-leo-stadium-type-deleteApi.php?sid=<?= $r['sid'] ?>" class="btn btn-danger">刪除</a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
